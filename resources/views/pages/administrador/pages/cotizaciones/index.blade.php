                ...
                @foreach($quotes as $quote)
                    <tr class="text-center">
                        ...
                        <td class="align-middle" style="width: 10%;">
                            ...
                            <button class="deleteRegister btn btn-rounded btn-outline-danger btn-xs mt-1" data-modal="deleteRegister" data-route="{{ route('quotes.destroy', $quote->id) }}" data-id="{{ $quote->id }}" title="Eliminar jugador">
