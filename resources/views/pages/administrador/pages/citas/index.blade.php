        ...
        <table class="dataTable table table-bordered table-striped change-table over-auto-datatable">
            ...
            <tbody>
                @foreach($cites as $cite)
                    <tr class="text-center">
                        <td class="align-middle" style="width: 20%;">{{ $cite->date }}</td>
                        <td class="align-middle" style="width: 20%;">{{ $cite->time }}</td>
                        <td class="align-middle" style="width: 15%;">{{ $cite->name }}</td>
                        <td class="align-middle" style="width: 15%;">{{ $cite->email }}</td>
                        <td class="align-middle" style="width: 15%;">{{ $cite->phone }}</td>
                        <td class="align-middle" style="width: 15%;">{{ $cite->description }}</td>
...
@include('pages.administrador.pages.citas.edit')
@endsection