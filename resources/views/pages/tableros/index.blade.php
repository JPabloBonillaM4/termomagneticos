...
@section('content')
    <div class="parallax-medium section1">
        <div class="text-white h-100 d-flex align-items-center justify-content-center">
            <p class="text-uppercase display-1 font-weight-bold r2_mobile text-center">tableros de distribución</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 m-auto">
                <h2 class="text-uppercase text-center col-md-12 my-5 display-4 font-weight-bold r2_mobile">corriente de empleo hasta 1250 A</h2>
                <div class="col-md-12">
                    <div>
                    ...
                    <div class="row">
                        <ul class="list-group list-group-flush col-md-6 pt-2">
                            <li class="list-group-item"><i class="fas fa-angle-right text-muted"></i> El sistema reduce el tiempo de instalación</li>
                            <li class="list-group-item"><i class="fas fa-angle-right text-muted"></i> Incrementa la flexibilidad modular</li>
                            <li class="list-group-item"><i class="fas fa-angle-right text-muted"></i> Montaje</li>
                            <li class="list-group-item"><i class="fas fa-angle-right text-muted"></i> Cubiertas para protección contra contactos accidentales</li>
                        </ul>
                ...
                <h2 class="text-uppercase text-center col-md-12 mt-5 mb-2 display-4 font-weight-bold r2_mobile">Aplicaciones</h2>
                <div class="col-md-12">
                    <div class="row text-center">
                        <div class="col-md-3 mt-2">
                            <a class="text-success" href="javascript:void(0)"><i class="fas fa-angle-right text-muted"></i> Sector comercial</a>
                        </div>
                        <div class="col-md-3 mt-2">
                            <a class="text-success" href="javascript:void(0)"><i class="fas fa-angle-right text-muted"></i> Farmacéutico</a>
                        </div>
                        <div class="col-md-3 mt-2">
                            <a class="text-success" href="javascript:void(0)"><i class="fas fa-angle-right text-muted"></i> Automotriz</a>
                        </div>
                        <div class="col-md-3 mt-2">
                            <a class="text-success" href="javascript:void(0)"><i class="fas fa-angle-right text-muted"></i> Alimentos</a>
                        </div>
                    </div>
                    <div class="row mt-3 mb-5">
                        <img src="{{ asset('images/section_3.jpg') }}" class="col-md-6 img-fluid mt-2" alt="">
                        <img src="{{ asset('images/section_3.jpg') }}" class="col-md-6 img-fluid mt-2" alt="">
                    </div>
                </div>
                ...
                <div class="row pt-3 pb-5">
                        ...
                        <div class="my-3">
                            ...
                            <div class="row align-items-center my-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p>Terminales separadas del bus</p>
                                </div>
                            </div>
                            <div class="row align-items-center my-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p>Unidades separadas y terminales separadas del bus</p>
                                </div>
                            </div>
                            <div class="row align-items-center my-3">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <p>Unidades y terminales en distinto compartimiento</p>
                                </div>
                            </div> 
                        </div>
                    </div>
                    <h2 class="text-uppercase text-center col-md-12 mt-5 mb-2 display-4 font-weight-bold r2_mobile">Modelo de negocio</h2>
                    <div class="row mt-4">
                        <div class="col-md-3">
                            <div class="text-center">
                                <img src="{{ asset('images/iec.png') }}" alt="" class="img-little">
                            </div>
                            <p class="text-uppercase text-center">usuario final</p>
                        </div>
                        <div class="col-md-3">
                            <div class="text-center">
                                <img src="{{ asset('images/iec.png') }}" alt="" class="img-little">
                    ...
                    <h2 class="text-uppercase text-center col-md-12 mt-5 mb-2 display-4 font-weight-bold r2_mobile">Solución Panel Builder</h2>
                </div>
            </div>
        </div>
    </div>
