...
<div class="background-simple background_contacto" id="inicio">
    <div class="background-shadow">
        <div class="container">
            <div class="row">
                <div class="col-md-9 m-auto py-5 text-white">
                    <h2 class="text-center">Termomagnéticos y Control de Radiaciones S.A de C.V</h2>
                    ...
                    <div class="row border border-white">
                        <div class="col-md-6 border-right border-white text-center py-5">
                            ...
                            <p class="d-flex align-items-center justify-content-center" class="text-white">
                                <a target="_blank" href="https://www.facebook.com/profile.php?id=100053532734263" class="text-white">
