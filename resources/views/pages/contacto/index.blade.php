...
<div class="container">
    <div class="row">
        <div class="col-md-9 m-auto py-5">
            <h4 class="text-center my-5 pb-5">Has contacto con alguno de nuestros representantes</h2>
            ...
            <div class="row my-5" id="cotizacion">
                ...
                <form action="" class="col-md-8 m-auto">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="cotización" rows="3" placeholder="Listado o descripción de su pedido" required></textarea>
                    </div>
