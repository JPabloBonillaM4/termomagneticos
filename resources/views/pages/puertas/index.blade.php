    ...
    <div class="row">
        ...
        <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
            ...
            <ul class="list-group list-group-flush col-md-6 pt-2">
                <li class="list-group-item"><i class="fas fa-angle-right text-muted mr-3"></i> Puerta de acceso Aceleración lineal</li>
                <li class="list-group-item"><i class="fas fa-angle-right text-muted mr-3"></i> Puerta de acceso Braquiterapia alta tasa de dosis</li>
                <li class="list-group-item"><i class="fas fa-angle-right text-muted mr-3"></i> Puerta de acceso Medicina nuclear</li>
            </ul>
        </div>
        ...
        <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
            ...
            <ul class="list-group list-group-flush col-md-6 pt-2">
                <li class="list-group-item pl-2"><i class="fas fa-angle-right text-muted mr-3"></i> Puerta de acceso Braquiterapia alta tasa de dosis</li>
            </ul>
        </div>
        <div class="col-md-10 mx-auto my-5">
        ...
        <div class="col-md-12 d-flex flex-column justify-content-center align-items-center">
            ...
            <ul class="list-group list-group-flush col-md-6 pt-2">
                <li class="list-group-item pl-0"><i class="fas fa-angle-right text-muted mr-3"></i> Puerta de acceso Aceleración lineal</li>
            </ul>
        </div>
        <div class="col-md-10 mx-auto my-5">
